package com.minuscule.matchit.config.dbmigrations;

import com.minuscule.matchit.domain.Authority;
import com.minuscule.matchit.domain.OAuth2AuthenticationClientDetails;
...
public class InitialSetupMigration {
    ...
    public void addOAuthClientDetails(MongoTemplate mongoTemplate) {
        ...
        appDetails.setClientId("MatchItapp");
        appDetails.setClientSecret("my-secret-token-to-change-in-production");
        appDetails.setResourceIds(Collections.singletonList("res_MatchIt"));
        ...
        swaggerUIDetails.setResourceIds(Collections.singletonList("res_MatchIt"));
