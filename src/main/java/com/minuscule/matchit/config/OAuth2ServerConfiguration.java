package com.minuscule.matchit.config;

import com.minuscule.matchit.config.oauth2.MongoDBApprovalStore;
import com.minuscule.matchit.config.oauth2.MongoDBAuthorizationCodeServices;
import com.minuscule.matchit.config.oauth2.MongoDBClientDetailsService;
import com.minuscule.matchit.config.oauth2.MongoDBTokenStore;
import com.minuscule.matchit.repository.*;
...
public class OAuth2ServerConfiguration {
    ...
    protected static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
        ...
        public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
            resources.resourceId("res_MatchIt").tokenStore(tokenStore);
        }
    }
